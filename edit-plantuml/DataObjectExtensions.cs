...
namespace Amg.Util
{
    ...
    class DataObjectWrapper
    {
            ...
            switch (format)
            {
                ...
                case "FileGroupDescriptorW":
                    ...
                    try
                    {
                        ...
                        //get the pointer to the first file descriptor
                        //get the pointer to the first file descriptor
                        var fileDescriptorPointer = fileGroupDescriptorWPointer + Marshal.SizeOf(fileGroupDescriptor.cItems);
        ...
        /// </returns>
        unsafe public MemoryStream GetData(string format, int index)
        {
            ...
            switch (medium.tymed)
            {
                ...
                case TYMED.TYMED_HGLOBAL:
                    ...
                    IntPtr mediumLock = NativeMethods.GlobalLock(medium.unionmember);
                    try
                    {
                        var size = NativeMethods.GlobalSize(mediumLock).ToInt64();
                    ...
                    var contentStream = new MemoryStream(fileContent, false);
